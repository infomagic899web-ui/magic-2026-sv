...
func CORSMiddleware(c fiber.Ctx) error {
	...
	csp := fmt.Sprintf(strings.Join([]string{
		...
		fmt.Sprintf("connect-src 'self' https://demo.magic899.com https://demo-test.magic899.com https://apidemo-test.magic899.com https://api.weatherapi.com https://cdn.weatherapi.com https://www.youtube.com %s", frontendOrigin),
